              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { num: "3", title: solution.step3, desc: solution.step3Desc, color: "bg-primary-600" },
                  ].map((step, idx) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {[solution.uc1, solution.uc2, solution.uc3, solution.uc4, solution.uc5].filter(Boolean).map((uc, idx) => (
                    <div key={idx} className="flex items-start gap-2">
                      <Check className="text-primary-600 flex-shrink-0" size={16} />
                      <span className="text-sm text-gray-600 leading-snug">{uc}</span>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 border-b border-gray-100">
                    ...
                    <div className="px-5 py-4 bg-gradient-to-bl from-accent-50 to-white">
                      ...
                      <p className="text-2xl font-bold text-accent-600">10-15</p>
                      <p className="text-xs text-gray-400">per clinician</p>
                    </div>
                  </div>
                  ...
                  <div className="px-5 py-4 space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-medium text-accent-600 bg-accent-50 px-2 py-0.5 rounded-full">Active</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-medium text-primary-600 bg-primary-50 px-2 py-0.5 rounded-full">Running</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                  ...
                  <div className="px-5 py-4 bg-gradient-to-r from-primary-50 to-accent-50 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xl font-bold text-accent-600">50x</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl overflow-hidden">
                  ...
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-3 border-r border-gray-100">
                      ...
                      <p className="text-xl font-bold text-primary-600">150+</p>
                    </div>
                    <div className="px-4 py-3">
                      <p className="text-xs text-gray-500">Hours saved</p>
                      <p className="text-xl font-bold text-accent-600">10-15</p>
                    </div>
                  </div>
                  <div className="px-4 py-3 bg-gradient-to-r from-primary-50 to-accent-50 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-bold text-accent-600">50x</p>
                      </div>
                    </div>
                  </div>
                </div>
