...
const TokenOptimizationPage = () => {
  const { t } = useLanguage();
  const solution = t.solutions.tokenOptimization;
  ...
  const steps = [
    { num: "1", icon: Layers, title: solution.step1, desc: solution.step1Desc },
    { num: "2", icon: Gauge, title: solution.step2, desc: solution.step2Desc },
    { num: "3", icon: BarChart2, title: solution.step3, desc: solution.step3Desc },
  ];

  const useCases = [
    { icon: Network, title: solution.uc1, desc: solution.uc1Desc },
    { icon: Wallet, title: solution.uc2, desc: solution.uc2Desc },
    { icon: ClipboardList, title: solution.uc3, desc: solution.uc3Desc },
    { icon: Workflow, title: solution.uc4, desc: solution.uc4Desc },
  ];
                ...
                <div className="bg-gradient-to-br from-primary-500 to-accent-500 rounded-2xl p-0.5 shadow-2xl">
                  <div className="bg-white rounded-2xl overflow-hidden">
                    ...
                    <div className="px-5 py-4 space-y-2">
                      {[
                        { icon: Network, label: d.row1Label, badge: d.badge1, color: "text-primary-700 bg-primary-50" },
                        { icon: Layers, label: d.row2Label, badge: d.badge2, color: "text-accent-700 bg-accent-50" },
                        { icon: ClipboardList, label: d.row3Label, badge: d.badge3, color: "text-gray-700 bg-gray-100" },
                      ].map((row, idx) => {
                        const Icon = row.icon;
                        return (
...
export default TokenOptimizationPage;
