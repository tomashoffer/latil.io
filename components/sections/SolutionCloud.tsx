                ...
                <div className="bg-white rounded-xl p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h4 className="text-lg font-bold text-gray-900">
                      {t.solutions.cloud.visual.title}
                    </h4>
                  ...
                  <div className="space-y-4">
                    <div className="bg-accent-50 border border-accent-200 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-gray-600">{t.solutions.cloud.visual.savings}</span>
                        <Zap className="text-accent-600" size={16} />
                      </div>
                      <div className="text-3xl font-bold text-accent-700">
                        $127K
                      </div>
                      <div className="text-xs text-accent-600 mt-1">
                        {t.solutions.cloud.visual.savingsChange}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
                        <div className="text-xs text-gray-600 mb-1">
                          {t.solutions.cloud.visual.optimizedResources}
                        </div>
                        <div className="text-2xl font-bold text-primary-700">342</div>
                      </div>
                      <div className="bg-accent-50 border border-accent-200 rounded-lg p-4">
                        <div className="text-xs text-gray-600 mb-1">
                          {t.solutions.cloud.visual.timeSaved}
                        </div>
                        <div className="text-2xl font-bold text-accent-700">156h</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm font-medium text-gray-900">
                          {t.solutions.cloud.visual.activeWorkflows}
                        </span>
                      </div>
                          ...
                          (workflow, idx) => (
                            ...
                            >
                              ...
                              <span className="text-accent-600 font-semibold">
                                {t.solutions.cloud.visual.active}
                              </span>
                            </div>
                          )
                        )}
